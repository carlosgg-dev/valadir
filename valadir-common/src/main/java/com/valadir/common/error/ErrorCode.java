...
public enum ErrorCode {
    ...
    INVALID_PASSWORD_RESET_OTP("BIZ-007", Category.UNAUTHORIZED),
    ACCOUNT_NOT_ELIGIBLE_FOR_REREGISTRATION("BIZ-006", Category.FORBIDDEN),
    INVALID_PASSWORD_RESET_VERIFICATION_TOKEN("BIZ-008", Category.UNAUTHORIZED),
    ...
    ACCOUNT_TEMPORARILY_LOCKED("SEC-007", Category.RATE_LIMITED),
    CAPTCHA_REQUIRED("SEC-008", Category.FORBIDDEN),
