...
public record RateLimitProperties(
    ...
    public record Rule(
        ...
        // Absent on purpose for a rule that guards a path whatever the verb, such as the per-user
        // budget over the whole API. A rule naming one endpoint names its method.
        HttpMethod method,
        @NotNull RateLimitStrategy strategy,
        @Positive int maxRequests,
        @NotNull Duration window) {

        public boolean appliesTo(String requestMethod) {
