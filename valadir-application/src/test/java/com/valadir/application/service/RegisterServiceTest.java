...
class RegisterServiceTest {
    ...
    void register_emailNotExist_persistsDataAndSendsOtp() {
        ...
        given(emailHolderResolver.replaceableHolderFor(email)).willReturn(Optional.empty());
    ...
    @Test
    void register_emailHeldByAnActiveAccount_propagatesTheConflictAndPersistsNothing() {
        ...
        given(emailHolderResolver.replaceableHolderFor(email)).willThrow(conflict);
    ...
    void register_pendingEmailExists_replacesPending() {
        ...
        var rawPassword = PasswordMother.raw();
        var newHashedPassword = PasswordMother.hashed();
        ...
        given(emailHolderResolver.replaceableHolderFor(email)).willReturn(Optional.of(existingAccountId));
