...
public class PasswordResetOtpRepositoryRedisAdapter implements PasswordResetOtpRepository {

    private final RedisTemplate<String, String> redisTemplate;

    public PasswordResetOtpRepositoryRedisAdapter(RedisTemplate<String, String> redisTemplate) {
